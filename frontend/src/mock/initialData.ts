...
export const INITIAL_ALERTS: Alert[] = [
  ...
  },
  {
    ...
    severity: 'critical',
    metric: 'Temp',
    title: 'Nhiệt độ nước Bể 01 tăng cao (24.8°C)',
    message: 'Nhiệt độ nước vượt 24.5°C làm tăng nguy cơ sốc nhiệt rễ và thối rễ.',
    reservoirId: 'res-01',
    resolved: true,
    suggestedAction: 'Bật quạt làm mát phòng và bổ sung nước mát hạ nhiệt độ bồn chứa.',
